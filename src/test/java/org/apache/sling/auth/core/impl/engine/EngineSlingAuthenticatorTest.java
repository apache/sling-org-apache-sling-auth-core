...
public class EngineSlingAuthenticatorTest {
    ...
    public void test_login_delegates() throws Exception {
        ...
        org.apache.sling.api.auth.Authenticator delegate = Mockito.mock(org.apache.sling.api.auth.Authenticator.class);
    ...
    public void test_login_wraps_exception() throws Exception {
        ...
        org.apache.sling.api.auth.Authenticator delegate = Mockito.mock(org.apache.sling.api.auth.Authenticator.class);
        SetField.set(bridge, "slingAuthenticator", delegate);
        Mockito.doThrow(new org.apache.sling.api.auth.NoAuthenticationHandlerException())
                .when(delegate)
                .login(
