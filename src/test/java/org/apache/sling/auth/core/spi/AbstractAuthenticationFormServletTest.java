...
public class AbstractAuthenticationFormServletTest {
    ...
    private static class TestFormServlet extends AbstractAuthenticationFormServlet {
    ...
    public void test_default_paths() {
        AbstractAuthenticationFormServlet servlet = new AbstractAuthenticationFormServlet() {
            @Override
            protected String getReason(HttpServletRequest request) {
                return "";
            }
